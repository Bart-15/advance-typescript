import { PizzaSchema, ExtraIngredientsSchema, ExtraIngredientSchema } from "./types";
...
export const extraIngredients: ExtraIngredientsSchema = {
    cheese: {
        name:"Cheese",
        price:40
    },
...
export const getExtraIngredients = (name: string) : ExtraIngredientSchema => extraIngredients[name] ?? { name, price: 0 };
